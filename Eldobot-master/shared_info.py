...
_TIP_DESCRIPTIONS = {
    ...
    'load': 'Load a FBGM export to get rolling',
    ...
    'nflcomp': 'Which real NFL player they resemble',
    ...
    'oroty': 'The OROTY race, top 10',
    'droty': 'The DROTY race, top 10',
    'opoty': 'The OPOTY race, top 10',
